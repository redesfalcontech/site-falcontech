  ...
  return (
    <div className="bg-zinc-950 text-slate-100 min-h-screen font-sans antialiased selection:bg-emerald-500 selection:text-slate-950 overflow-x-hidden">
      ...
      >
        ...
        <div className="absolute inset-y-0 right-0 w-full lg:w-[78%] z-0 pointer-events-none">
          <img 
            src={heroBg} 
            alt="FalconTech Rastreamento" 
            className="w-full h-full object-cover object-[25%_center] lg:object-[28%_center] select-none"
